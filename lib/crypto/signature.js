...
Signature.fromCompact = function(buf) {
  ...
  var compressed = true;
  var i = [].slice.call(buf, 0, 1)[0] - 27 - 4;
  if (i < 0) {
    compressed = false;
    i = i + 4;
  }

  var b2 = new Buffer([].slice.call(buf, 1, 33));
  var b3 = new Buffer([].slice.call(buf, 33, 65));
...
Signature.fromTxFormat = function(buf) {
  ...
  var derbuf = new Buffer([].slice.call(buf, 0, buf.length - 1));
...
Signature.parseDER = function(buf, strict) {
  ...
  var length = buf[1];
  var buflength = [].slice.call(buf, 2).length;
  ...
  var rlength = buf[2 + 1];
  var rbuf = new Buffer([].slice.call(buf, 2 + 2, 2 + 2 + rlength));
  ...
  var sbuf = new Buffer([].slice.call(buf, 2 + 2 + rlength + 2, 2 + 2 + rlength + 2 + slength));
...
Signature.isTxDER = function(buf) {
  ...
  var R = new Buffer([].slice.call(buf, 4));
  if (buf[4 - 2] !== 0x02) {
  ...
  var S = new Buffer([].slice.call(buf, 6 + nLenR));
